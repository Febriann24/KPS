...
function HubungiKami() {
    ...
    return (
        ...
        <div className="grid grid-cols-2 justify-items-center mt-[10px]">
            ...
            <p id="helper-text-explanation" class="mt-2 text-sm text-gray-500 ml-[24px]">We’ll never share your details. Read our <a href="#" class="font-medium text-blue-600 hover:underline">Privacy Policy</a>.</p>
            ...
            <div className="bg-gradient-to-b from-[#4AA1B4] to-[#57C1A0] w-[580px] h-[610px] mr-[220px]">
                <h1 className="text-[50px] ml-[40px]">INFO <hr class="my-6 border-gray-200  dark:border-gray-700" /></h1>
                <div className="flex items-center  my-[40px]"> 
                    <PersonIcon className="mx-[30px]" style={{ width: '80px', height: '80px' }} /> no telpon
                </div>
                <div className="flex items-center  my-[40px]">
                    <EnvelopeOpenIcon className="mx-[30px]" style={{ width: '80px', height: '80px' }}/> nikolasfebriann@gmail.com
                </div>
                <div className="flex items-center  my-[40px]">
                    <HomeIcon className="mx-[30px]" style={{ width: '80px', height: '80px' }}/> lokasi
                </div>
                <div className="flex items-center my-[40px]">
                    <ClockIcon className="mx-[30px]" style={{ width: '80px', height: '80px' }}/>time
                </div>
            </div>
        </div>
        <F/>
