      ...
      <div className="flex-grow p-10">
        ...
        <div className="relative flex justify-between items-center px-16 py-8">
          ...
          <div className="relative flex flex-col items-center">
            ...
            <span className="mt-2 text-green-500 font-semibold">Menunggu Proses</span>
            <span className="text-green-500 font-semibold">Pengalihan Dana</span>
          </div>
