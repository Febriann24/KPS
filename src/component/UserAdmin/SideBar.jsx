...
function Sidebar() {
  return (
    <div className="w-64 h-screen bg-gray-50 flex flex-col p-4 text-black shadow-[0.5px_0px_5px_rgba(0,0,0,0.3)]">
      <h2 className="text-2xl font-bold mb-6 text-center">Pengaturan</h2>
      <hr className="h-1 w-full border-0 bg-black "/ >
