  ...
  return (
    <div className="w-64 h-screen bg-gray-50 flex flex-col justify-start p-4 text-black shadow-[0.5px_0px_5px_rgba(0,0,0,0.3)]">
      ...
      <ul className="mt-5 text-[17px]">
        <li className="mb-4 flex items-center transition-all duration-400  hover:cursor-pointer hover:text-white hover:bg-gradient-to-b from-[#4AA1B4] to-[#57C1A0] p-2 rounded">
