...
function ModalEditAccManagement({ setIsEditModalOpened, setSelectedUser, selectedUser }) {
  ...
  useEffect(() => {
    setName(selectedUser.GS_NAME);
    setDescription(selectedUser.GS_DESC);
    setCode(selectedUser.GS_CODE);
    setDataType(selectedUser.DATA_TYPE);
    setValue(selectedUser.GS_VALUE);
